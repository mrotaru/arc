...
export const resourceListReadRequest = (resource, params, urlOptions) => ({
...
export const resourceDetailReadRequest = (resource, needle, urlOptions) => ({
...
export const resourceDetailReadSuccess = (resource, detail, request, thunk, urlOptions) => ({
...
export const resourceDetailReadFailure = (resource, error, request, thunk, urlOptions) => ({
